...
func Test_Parse(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"Single Add",
			singleAddTestData,
			aoc22_10.Day10{Cycle: 0, X: map[int]int{0: 0, 1: 1}, Commands: []aoc22_10.Command{{Instruction: aoc22_10.Add, Value: 5}}},
			assert.NoError,
		},
		{
			"Single Noop",
			singleNoopTestData,
			aoc22_10.Day10{Cycle: 0, X: map[int]int{0: 0, 1: 1}, Commands: []aoc22_10.Command{{Instruction: aoc22_10.Noop, Value: 0}}},
			assert.NoError,
		},
		{
			"Mixed",
			[]string{"noop", "addx 5", "addx -3", "noop", "addx 1"},
			aoc22_10.Day10{Cycle: 0, X: map[int]int{0: 0, 1: 1}, Commands: []aoc22_10.Command{
...
func Test_Process(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			"Single Add",
			aoc22_10.Day10{Cycle: 0, X: map[int]int{0: 0, 1: 1}, Commands: []aoc22_10.Command{{Instruction: aoc22_10.Add, Value: 5}}},
			aoc22_10.Day10{Cycle: 0, X: map[int]int{0: 0, 1: 1}, Commands: []aoc22_10.Command{}, Cycle20: 0, Cycle60: 0, Cycle100: 0, Cycle140: 0, Cycle180: 0, Cycle220: 0},
			assert.NoError,
		},
		{
			"Single Noop",

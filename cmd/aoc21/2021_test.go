...
func Test_2021(t *testing.T) {
	tests := []struct {
		...
		{"2021-2a Example", aoc21.D2P1, []string{"forward 5", "down 5", "forward 8", "up 3", "down 8", "forward 2"}, "150"},
		{"2021-2a Example", aoc21.D2P2, []string{"forward 5", "down 5", "forward 8", "up 3", "down 8", "forward 2"}, "900"},
	}
